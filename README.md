...
4. **Publish** — Outputs `LiveWatch-PlaylistBR.m3u8` / `LiveWatch-PlaylistWorld.m3u8` and pushes back to this repository
...
│   ├── app.js
│   └── style.css
├── LiveWatch-PlaylistBR.m3u8         # BR playlist (auto-committed by Actions)
├── LiveWatch-PlaylistWorld.m3u8      # World playlist (auto-committed by Actions)
└── .gitignore
```
